...
resource_groups | no | list(object()) | [] | [Example](#arguments-resource_groups-example) | A list of objects, used to create zero or more resource groups.
...
Arguments | Required | Type | Default | Example | Description
--------- | -------- | ---- | ------- | ------- | -----------
location | yes* | string | | [Example](#arguments-resource_groups-example) | Resource location.
name | yes | string | | [Example](#arguments-resource_groups-example) | Resource name.
tags | no | map(string) | | [Example](#arguments-resource_groups-example) | Resource tags, these tags will be combined with required tags if provided.
